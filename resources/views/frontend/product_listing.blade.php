        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="box-content">
                            <div class="category-accordion">
                                ...
                                <div class="single-category">
                                    <button class="btn w-100 category-name collapsed" type="button" data-toggle="collapse" data-target="#brand" aria-expanded="true">

                                            <a class="text-muted" href="{{ route('products.brand', $brand->slug) }}">{{ __($brand->name) }}</a>
                ...
                <div class="col-xl-8 col-md-6 col-sm-12">
                    <!-- <div class="bg-white"> -->
                    <div class="brands-bar row no-gutters bg-white">
                        <div class="col-11">
...
@if(home_base_price($product->id) != home_discounted_base_price($product->id))
                ...
                <div class="col-xl-2  col-md-2 col-sm-12">
                        ...
                        <div class="home-slide">
                            <div class="home-slide">
                                <div class="slick-carousel" data-slick-arrows="true" data-slick-dots="true" data-slick-autoplay="true">
                                    @foreach (\App\Add::where('published', 1)->get() as $key => $adds)
                                        <div class="" style="height:475px;">
                                            <img class="d-block w-100 h-100" src="{{ asset($adds->photo) }}" alt="Slider Image">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <!--<div class="col-lg-12 mt-5 order-1 order-lg-0">-->
                    <!--    <div class="home-slide">-->
                    <!--        <div class="home-slide">-->
                    <!--            <div class="slick-carousel" data-slick-arrows="true" data-slick-dots="true" data-slick-autoplay="true">-->
