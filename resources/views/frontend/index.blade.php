                ...
                <div class="col-lg-3 position-static order-2 order-lg-0">
                    <div class="category-sidebar">
                        <div class="all-category d-none d-lg-block">
                            <span class="fa fa-bars"> {{__('Categories')}}</span>
                        ...
                        <ul class="categories no-scrollbar">
                            ...
                            <div class="">
                                <ul class="sub-cat-items">
                                    <a href="{{ route('categories.all') }}">
                                        <span class="d-none d-lg-inline-block fa fa-plus mb-2">{{__(' All Categories')}} ></span>
                                    </a>
                                </ul>
                            </div>
            ...
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                <div class="section-title-1 clearfix">
                    <h3 class="heading-5 strong-700 mb-0 float-left">
                        <span class="mr-4">{{__("Today's Deal")}}</span>
                    </h3>
                </div>
                <div class="caorusel-box">
                    <div class="slick-carousel" data-slick-items="6" data-slick-xl-items="5" data-slick-lg-items="4"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2">
                        @foreach (filter_products(\App\Product::where('published', 1)->where('todays_deal', '1'))->orderBy('id', 'desc')->get() as $key => $product)
                        
                        <div class=" card-product m-2 shop-cards shop-tech">
                            
                            <div class="product-box-2 bg-white alt-box my-2">
                                    <div class="position-relative overflow-hidden">
                                        <a href="{{ route('product', $product->slug) }}" class="d-block product-image h-100 img-fluid" style="background-image:url('{{ asset($product->thumbnail_img) }}');" tabindex="0">
                                        </a>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <!--<button class="add-to-cart btn btn-outline-danger" title="Add to Cart" onclick="showAddToCartModal({{ $product->id }})">-->
                                        <!--    <i class="la la-shopping-cart"></i>-->
                                        <!--</button>-->
                                        <button class="add-to-cart btn btn-outline-danger" title="Add to Cart">
                                            <a  href="{{ route('product', $product->slug) }}"><i class="la la-shopping-cart"></i></a>
                                        </button>
                                        </div>
                                        <div class="price-box">
                                            @if(home_base_price($product->id) != home_discounted_base_price($product->id))
                    ...
                    <div class="slick-carousel" data-slick-items="6" data-slick-xl-items="5" data-slick-lg-items="4"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2">
                        @foreach (filter_products(\App\Product::where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(20)->get() as $key => $product)
                            <div class="  card-product m-2 shop-cards shop-tech">
                                ...
                                <!--    <div class="card-image">-->
                                <!--        <a href="{{ route('product', $product->slug) }}" class="d-block" style="background-image:url('{{ asset($product->thumbnail_img) }}');">-->
                                <!--        </a>-->
                                <!--    </div>-->
    ...
    <section class="mb-4">
        <div class="container">
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                <div class="section-title-1 clearfix">
                    <h3 class="heading-5 strong-700 mb-0 float-left">
                        <span class="mr-4">{{__('Recent Products')}}</span>
                    </h3>
                </div>
                <div class="caorusel-box">
                    <div class="slick-carousel" data-slick-items="6" data-slick-xl-items="5" data-slick-lg-items="4"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2">
