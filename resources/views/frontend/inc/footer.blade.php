                    ...
                    <div class="text-center ">
                        <ul class="inline-links">
                            @if (\App\BusinessSetting::where('type', 'paypal_payment')->first()->value == 1)
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/paypal.png')}}" height="30" width="50">
                                </li>
                            @endif
                            @if (\App\BusinessSetting::where('type', 'stripe_payment')->first()->value == 1)
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/stripe.png')}}" height="30" width="50">
                                </li>
                            @endif
                            @if (\App\BusinessSetting::where('type', 'sslcommerz_payment')->first()->value == 1)
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/sslcommerz.png')}}" height="30" width="50">
                                </li>
                            @endif
                            @if (\App\BusinessSetting::where('type', 'instamojo_payment')->first()->value == 1)
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/instamojo.png')}}" height="30" width="50">
                                </li>
                            @endif
                            @if (\App\BusinessSetting::where('type', 'razorpay')->first()->value == 1)
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/rozarpay.png')}}" height="30" width="50">
                                </li>
                            @endif
                            @if (\App\BusinessSetting::where('type', 'paystack')->first()->value == 1)
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/paystack.png')}}" height="30" width="50">
                                </li>
                            @endif
                            @if (\App\BusinessSetting::where('type', 'cash_payment')->first()->value == 1)
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/cod.png')}}" height="30" width="50">
                                </li>
                            @endif
                        </ul>
                    </div>
