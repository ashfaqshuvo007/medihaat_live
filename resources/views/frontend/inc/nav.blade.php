            ...
            <div class="row">
                            ...
                            <ul class="dropdown-menu">
                                @foreach (\App\Language::all() as $key => $language)
                                    <li class="dropdown-item @if($locale == $language) active @endif">
                                        ...
                                        <a href="#" data-flag="{{ $language->code }}"><span class="language">{{ $language->name }}</span></a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        <li class="">
                            <a style="font: 14px bold" href="#" class="top-bar-item">{{__('Get Apps ')}}<span class="fa fa-mobile"></span></a>
                        </li>
                        <li>
                            @if (\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                <a style="font: 14px bold" href="{{ route('shops.create') }}" class="top-bar-item">
                                    {{__('Be a Seller')}}
                                </a>
                        @endif
                        </li>
                        <!--<li>-->
                        <!--    <a style="font: 14px bold" href="{{ route('orders.track') }}" class="top-bar-item">{{__('Track Order')}}</a>-->
                        <!--</li>-->
                        <!--<li class="dropdown ac">-->
                        <!--    <a style="font: 14px bold" href="javascript:void(0)" class="dropbtn top-bar-item"><span class="fa fa-user"></span> Account <span class="fa fa-caret-down"></span></a>-->
                        <!--    <div class="dropdown-content">-->
                        <!--      @auth-->
                       
                        <!--    <a style="font: 14px bold" href="{{ route('dashboard') }}" class="">{{__('My Panel')}}</a>-->
                        
                        
                        <!--    <a style="font: 14px bold" href="{{ route('logout') }}" class="">{{__('Logout')}}</a>-->
                            
                        <!--    <a style="font: 14px bold" href="{{ route('orders.track') }}" class="">{{__('Track Order')}}</a>-->
                        
                        <!--@else-->
                        
                        <!--    <a style="font: 14px bold" href="{{ route('user.login') }}" class="">{{__('Login')}}</a>-->
                        
                        
                        <!--    <a style="font: 14px bold" href="{{ route('user.registration') }}" class="">{{__('Registration')}}</a>-->
                            
                        <!--    <a style="font: 14px bold" href="{{ route('orders.track') }}" class="">{{__('Track Order')}}</a>-->
                        
                        <!--@endauth-->
                        <!--    <div class="nav-compare-box" id="compare">-->
                        <!--                    <a href="{{ route('compare') }}" style="font: 14px bold" class="nav-box-link">-->
                        ...
                        <!--@auth-->
                        <!--<li>-->
                        <!--    <a style="color: #0c0c0c;font: 14px bold" href="{{ route('dashboard') }}" class="top-bar-item">{{__('My Panel')}}</a>-->
                        <!--</li>-->
                        <!--<li>-->
                        <!--    <a style="color: #0c0c0c;font: 14px bold" href="{{ route('logout') }}" class="top-bar-item">{{__('Logout')}}</a>-->
                        <!--</li>-->
                        <!--@else-->
                        <!--<li>-->
                        <!--    <a style="color: #0c0c0c;font: 14px bold" href="{{ route('user.login') }}" class="top-bar-item">{{__('Login')}}</a>-->
                        <!--</li>-->
                        <!--<li>-->
                        <!--    <a style="color: #0c0c0c;font: 14px bold" href="{{ route('user.registration') }}" class="top-bar-item">{{__('Registration')}}</a>-->
                        <!--</li>-->
                        <!--@endauth-->
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-3 col-8">
                        <div class="d-flex">
                            ...
                            <!-- Brand/Logo -->
                            <a class="navbar-brand w-100 d-none d-xl-block d-lg-block d-md-block" href="{{ route('home') }}">
                                @php
                        ...
                        <div class="d-flex w-100">
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative" style="border: 2px solid red">
                                        ...
                                        <div class="form-group category-select d-none d-xl-block">
                                            <select class="form-control" name="category">
                                                ...
                                                <!--<option value="">{{__('Sourcing Requests')}}</option>-->
                                                <!--@foreach (\App\Category::all() as $key => $category)-->
                                        ...
                                        <div class="w-100">
                                            <input type="text" aria-label="Search" id="search" name="q" class="w-100 border-danger" placeholder="Enter a keyword for search" autocomplete="off">
                                        </div>
                            ...
                            <div class="logo-bar-icons d-inline-block ml-auto">
                                ...
                                <div class="d-none d-lg-inline-block">
                                    ...
                                    <li class="dropdown ac">
                            <a style="font: 14px bold" href="javascript:void(0)" class="dropbtn top-bar-item"><span class="fa fa-user fa-2x text-gray"></span> <span class="fa fa-caret-down"></span></a>
                            <div class="dropdown-content">
                              @auth
                                ...
                                <div class="d-inline-block" data-hover="dropdown">
                                    <div class="nav-cart-box dropdown" id="cart_items">
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fa fa-shopping-cart fa-2x d-inline-block nav-box-icon"></i>
